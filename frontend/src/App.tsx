...
import { Historial } from './presentation/pages/Finance/Historial/Historial';
    ...
    <ProtectedRoute user={user}>
      <div className="min-h-screen bg-[#0c0c0c]">
        ...
        <main className="max-w-7xl mx-auto p-4 md:p-6">
          {/* Aquí antes estaba el FinanceSubNav, ya lo hemos eliminado */}
          ...
          <Routes>
            ...
            <Route path="/finance/historial" element={<Historial />} />
