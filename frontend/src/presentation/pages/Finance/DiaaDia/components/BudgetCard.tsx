...
// Añadimos monthId a la interfaz de props
interface BudgetCardProps {
  budget: number;
  transactions: any[];
  monthId: string; // <--- Añadido para solucionar el error de tipado
}
  ...
  return (
    <div className="bg-[#1a1a1a] border border-[#2d2d2d] rounded-xl p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="bg-[#2d2d2d] p-1.5 rounded-md text-gray-400 hover:text-white transition-colors">
          <Edit2 size={14} />
        </button>
      </div>
